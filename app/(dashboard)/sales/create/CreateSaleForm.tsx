...
export default function CreateSaleForm() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // Reset form and redirect to sales page
      resetForm()
    ...
    <div className="container mx-auto py-6 space-y-6">
      ...
      <Card>
              ...
              <Popover open={isCustomerPopoverOpen} onOpenChange={setIsCustomerPopoverOpen}>
                <PopoverTrigger asChild>
                  <Button variant="outline" role="combobox" className="w-full justify-between">
                    {formData.customer
                      ? customers.find((customer) => customer._id === formData.customer)?.name || "Select customer"
                      : "Select customer"}
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-4">
              {formData.items.map((item, index) => (
                <div key={index} className="grid grid-cols-12 gap-2 items-end border p-4 rounded-md">
        ...
        <CardFooter className="flex justify-end gap-2">
          <Button variant="outline" onClick={() => router.push("/sales")} disabled={isSubmitting}>
            Cancel
          </Button>
          <Button
